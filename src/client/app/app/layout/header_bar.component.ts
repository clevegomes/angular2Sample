...
export class HeaderBarComponent implements OnInit, DoCheck {
    ...
    constructor(private _profile_service : ProfileService,private _router: Router,private _employer_service:EmployerService,
                private _activeRoute:ActivatedRoute,private fb:FormBuilder, private _accountService:AccountService,
